...
![Version: 0.7.0](https://img.shields.io/badge/Version-0.7.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.18.5](https://img.shields.io/badge/AppVersion-v0.18.5-informational?style=flat-square)

A Helm chart for onetimesecret. Install the latest release with

`helm install onetimesecret oci://ghcr.io/venkatamutyala/helm-chart/onetimesecret`
